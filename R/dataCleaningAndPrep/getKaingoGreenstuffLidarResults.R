...
### adapt filepath! 
files.raw <- as.data.table(list.files("O:/Nat_Ecoinformatics/C_Write/_User/JonasTrepel_au713983/DataAndResources/Waterberg_LiDAR/exported files/Greenstuff e57/", pattern = ".laz", full.names = TRUE))
...
fwrite(reserve_lidar, "data/processedData/dataFragments/KaingoGreenstuffLidarResultsWaterberg2024Radius20m.csv")
