...
ggsave(plot = p.resi, "builds/plots/resilienceGridGLMM.png", dpi = 600, height = 10, width = 9)
...
ggsave(plot = p.str, "builds/plots/structureGridGLMM.png", dpi = 600, height = 10, width = 7)
...
ggsave(plot = p_fig2_ab_leg, "builds/plots/fig2.png", dpi = 600, height = 8, width = 12)
...
ggsave(plot = p_fig3, "builds/plots/fig3.png", dpi = 600, height = 9, width = 12)
...
ggsave(plot = p_fig4, "builds/plots/fig4.png", dpi = 600, height = 8.5, width = 12)
...
ggsave(plot = p_fig5, "builds/plots/fig5.png", dpi = 600, height = 6, width = 10)
