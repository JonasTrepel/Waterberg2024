...
vars.plot <- c(
  ...
  "nEventsDay_scaled*MAP_plot_scaled"
)
...
vars.site <- c(
  ...
  "nEventsDay_scaled*MAP_site_scaled")
...
vars.reserve <- c(
  ...
  "nEventsDayReserve_scaled*MAP_scaled")
...
fwrite(estimates, "builds/modelOutputs/interactionEstimates.csv")
